...
public class Calc implements ActionListener{
    ...
    Font myFont = new Font("DS-Digital", Font.BOLD, 25);
    Font buttonFont = new Font("Neue Haas Grotesk Text Pro", Font.BOLD, 20);
	...
	// too many buttons so creating for loop for actions
	for (int i = 0; i < 9; i++) {
	    actionButtons[i].addActionListener(this);
	    actionButtons[i].setFont(buttonFont);
	    actionButtons[i].setFocusable(false); // gets rid of outline of button when clicked
	}
	...
	// set bounds for delete and clear
	negButton.setBounds(50, 430, 100, 50);
	delButton.setBounds(150, 430, 100, 50);
	clrButton.setBounds(250, 430, 100, 50);
	
	// JPanel to hold all buttons
	panel = new JPanel();
	...
	// make buttons perform actions (update text field)
	for (int i = 0; i < 10; i++) {
